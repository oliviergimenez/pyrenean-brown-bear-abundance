...
We estimate abundance of the Pyrenean brown bear population with data from France and Spain using robust-design capture-recapture models. We consider data from 2008 to 2021 considering the period May to September. 
...
```{r}
rawdata <- read_csv2("dat/databaseCMR2022.csv", col_names = FALSE)
rawdata
```
...
```{r}
dates <- seq(from = as.Date("2008/5/1"), to = as.Date("2021/9/1"), by = "month") %>% 
...
```{r}
n.primary <- 14 # number of primary occasions
